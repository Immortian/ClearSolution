...
namespace Notes.Identity.Controllers
{
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel viewModel)
        {
            ...
            var result = await _signInManager.PasswordSignInAsync(viewModel.Username, viewModel.Passwprd, false, false);
            if(result.Succeeded)
            {
        ...
        public async Task<IActionResult> Logout(string logoutId)
        {
            ...
            var lououtRequest = await _interactionService.GetLogoutContextAsync(logoutId);
            return Redirect(lououtRequest.PostLogoutRedirectUri);
        }
    }
}
